 ...
 */
    ...
    public String testPhones(String phoneNumber) {
        ...
        try {
            ...
            //调用方法接收返回值
            SendSmsResponse sendSmsResponse = testPhoneMsg(phoneNumber,"小蛋黄","SMS_172008044","{\"code\":\""+random+"\"}");
    ...
    public void getPhoneMsg(){
        String message = testPhones("15299052097,17703838389,13007600921");
    ...
    public void testPhoneUtil(){
        ...
        String message = PhoneMsgUtil.getPhones("15299052097,17703838389",random);
        System.out.println(message);
    }
