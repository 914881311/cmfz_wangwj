    ...
    <script>
        $(function(){
            ...
            $.extend($.validator.messages, {
                required: "<span style='color:#c90000' >这是必填字段</span>",
                minlength: $.validator.format("<span style='color:#c90000' >最少要输入6个字符</span>"),
            });
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="" method="post" class="login-form" id="loginForm">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" minlength="6" name="password" placeholder="请输入密码..." class="form-password form-control" required id="form-password">
                            </div>
                            <div class="form-group">
