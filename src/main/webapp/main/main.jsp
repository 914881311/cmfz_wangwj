...
<nav class="navbar navbar-default">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            <a class="navbar-brand" href="${path}/main/main.jsp">持明法州后台管理系统</a>
        </div>
    ...
    <div class="row">
            ...
            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true" align="center">
                    ...
                    <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li>
                                    <button class="btn btn-warning">
                                        <a href="javascript:$('#mainId').load('${path}/User/goEasyEcharts.jsp')">用户统计</a>
                                    </button>
                                </li><br>
                                <li>
                                    <button class="btn btn-warning">
                                        <a href="javascript:$('#mainId').load('${path}/User/chinaJsonController.jsp')">用户分布</a>
                                    </button>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="panel panel-primary">
                    ...
                    <div id="collapseFive" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFive">
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked">
                                <li><button class="btn btn-primary">上师信息</button></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-md-10" id="mainId">
            ...
            <div class="panel panel-footer" align="center">
                <div> 百知教育wangwj@zparkhr.com</div>
            </div>
        </div>
    </div>
</div>
